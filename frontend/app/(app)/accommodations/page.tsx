      ...
      <div className="px-4 py-4 space-y-3">
        ...
        {!isLoading && accommodations.length === 0 && !editing && (
          <div className="flex flex-col items-center py-12 text-center">
            ...
            <h2 className="text-lg font-semibold text-gray-700">No saved places yet</h2>
            <p className="mt-1 text-sm text-gray-400">Save your vacation home, cabin, or any place you visit regularly</p>
            <button
              onClick={() => setEditing("new")}
        ...
        {accommodations.map((accommodation) => (
          <div key={accommodation.id} className="flex items-center gap-3 rounded-xl border border-gray-100 bg-white p-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {accommodation.notes && (
                <p className="mt-0.5 text-xs text-gray-400 truncate">{accommodation.notes}</p>
              )}
            </div>
