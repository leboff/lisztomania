      ...
      <div className="px-4 py-4 space-y-3">
        ...
        {!isLoading && profiles.length === 0 && !editing && (
          <div className="flex flex-col items-center py-12 text-center">
            ...
            <h2 className="text-lg font-semibold text-gray-700">No travelers yet</h2>
            <p className="mt-1 text-sm text-gray-400">Add family members and travel companions</p>
            <button
              onClick={() => setEditing("new")}
        ...
        {profiles.map((profile) => (
          <div key={profile.id} className="flex items-center gap-3 rounded-xl border border-gray-100 bg-white p-4">
