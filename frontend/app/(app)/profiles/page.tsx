      ...
      <div className="px-4 py-4 space-y-3">
        ...
        {!isLoading && profiles.length === 0 && !editing && (
          <div className="flex flex-col items-center py-12 text-center">
            ...
            <h2 className="text-lg font-semibold text-gray-700 dark:text-gray-200">No travelers yet</h2>
            <p className="mt-1 text-sm text-gray-400 dark:text-gray-500">Add family members and travel companions</p>
            <button
              onClick={() => setEditing("new")}
        ...
        {profiles.map((profile) => (
          <div key={profile.id} className="flex items-center gap-3 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-800 p-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              {profile.notes && (
                <p className="mt-0.5 text-xs text-gray-400 dark:text-gray-500 truncate normal-case">{profile.notes}</p>
              )}
            </div>
            <div className="flex gap-1">
              ...
              <button
                ...
                className="flex h-9 w-9 items-center justify-center rounded-full hover:bg-red-50 dark:hover:bg-red-900/20"
              >
                <svg className="h-4 w-4 text-gray-300 dark:text-gray-600 hover:text-red-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
