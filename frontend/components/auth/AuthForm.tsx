  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="w-full max-w-sm">
        ...
        {isSignup && (
          <p className="mb-8 text-sm text-gray-500 dark:text-gray-400">Start packing smarter today.</p>
        )}

        <button
          onClick={handleGoogle}
          className={`${isSignup ? "" : "mt-8 "}mb-4 flex w-full items-center justify-center gap-2 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 py-3 text-sm font-medium text-gray-700 dark:text-gray-200 shadow-sm hover:bg-gray-50 dark:hover:bg-gray-700 active:bg-gray-100 dark:active:bg-gray-600`}
        >
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full rounded-xl bg-indigo-500 py-3 text-sm font-semibold text-white hover:bg-indigo-600 active:bg-indigo-700 disabled:opacity-60"
          >
            {loading
